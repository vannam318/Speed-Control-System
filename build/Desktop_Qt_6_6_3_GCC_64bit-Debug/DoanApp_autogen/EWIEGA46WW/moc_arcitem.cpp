...
struct qt_meta_stringdata_CLASSArcItemENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSArcItemENDCLASS = QtMocHelpers::stringData(
    "ArcItem",
    "startAngleChanged",
    "",
    "sweepAngleChanged",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSArcItemENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSArcItemENDCLASS_t qt_meta_stringdata_CLASSArcItemENDCLASS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CLASSArcItemENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ArcItem::staticMetaObject = { {
    QMetaObject::SuperData::link<QQuickPaintedItem::staticMetaObject>(),
    qt_meta_stringdata_CLASSArcItemENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSArcItemENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSArcItemENDCLASS_t,
        // property 'startAngle'
        QtPrivate::TypeAndForceComplete<float, std::true_type>,
        // property 'sweepAngle'
        QtPrivate::TypeAndForceComplete<float, std::true_type>,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ArcItem, std::true_type>,
        // method 'startAngleChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'sweepAngleChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void ArcItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ArcItem::startAngleChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ArcItem::*)();
            if (_t _q_method = &ArcItem::sweepAngleChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *ArcItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSArcItemENDCLASS.stringdata0))
