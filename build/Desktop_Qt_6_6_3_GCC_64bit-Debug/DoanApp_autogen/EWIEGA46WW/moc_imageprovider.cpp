...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSImageProviderENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSImageProviderENDCLASS_t qt_meta_stringdata_CLASSImageProviderENDCLASS = {
    {
        QT_MOC_LITERAL(0, 13),  // "ImageProvider"
        QT_MOC_LITERAL(14, 20),  // "detectedClassChanged"
        QT_MOC_LITERAL(35, 0),  // ""
        QT_MOC_LITERAL(36, 13)   // "detectedClass"
    },
    "ImageProvider",
    "detectedClassChanged",
    "",
...
void ImageProvider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->detectedClassChanged(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ImageProvider::detectedClassChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->detectedClass(); break;
        default: break;
        }
...
// SIGNAL 0
void ImageProvider::detectedClassChanged()
{
